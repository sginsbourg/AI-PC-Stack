...
echo Upgrading pip to avoid permission issues...
python -m pip install --upgrade pip

echo Installing required Python libraries...
python -m pip install langchain langchain-community langchain-ollama pypdf chromadb gradio PyPDF2
...
echo Pulling qwen:0.5b for RAG system...
